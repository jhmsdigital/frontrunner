...
const quadrants = [
  {
    ...
    title: 'Strengths',
    color: 'bg-sky-50',
    borderColor: 'border-ms-skyBlue',
    headerColor: 'bg-ms-navy',
    items: [] as SwotItem[],
  },
  {
  ...
  },
  {
    ...
    title: 'Opportunities',
    color: 'bg-amber-50',
    borderColor: 'border-ms-gold/40',
    headerColor: 'bg-ms-gold',
    items: [] as SwotItem[],
  },
  {
    ...
    title: 'Threats',
    color: 'bg-slate-50',
    borderColor: 'border-ms-lightGray',
    headerColor: 'bg-ms-oceanBlue',
    items: [] as SwotItem[],
  },
];
